...
(D3nome = function ( config ) {
    ...
    draw: function () {
        ...
        var buf = "<div id='d3nome-canvas-container' style='width: " + this.totSvgDims.x + "px;'>" +
        ...
        buf += "<select id='d3nome-chromosome-selector'>";
        ...
        $( this.config.container ).resizable( {
            ...
            resize: $.proxy( function ( event, ui ) {
                ...
                // reset the x grid - could also do initSvgViewer(), but that's rather slow
                this.calcDims();
                this.setXGrid();
    ...
    initChromosomeSelectorMenu: function () {
    ...
    drawFeatureData: function () {
        ...
        transcriptGroups.selectAll( "g.d3nome-transcript" )
                        ...
                        .append( "rect" )
                        .attr( "class", function ( d ) {
                            return "d3nome-feature-utr " + d.direction;
                        } )
                        .attr( "x", $.proxy( function ( d, i ) {
                            return this.viewXScale( d.start ) + this.horizMargin;
                        }, this ) )
        ...
        transcriptGroups.selectAll( "g.d3nome-transcript" )
                        ...
                        .append( "rect" )
                        .attr( "class", function ( d ) {
                            return "d3nome-feature-cds " + d.direction;
                        } )
                        .attr( "x", $.proxy( function ( d, i ) {
                            return this.viewXScale( d.start ) + this.horizMargin;
                        }, this ) )
